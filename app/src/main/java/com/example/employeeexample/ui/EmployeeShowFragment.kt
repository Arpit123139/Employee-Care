...
import com.example.employeeexample.ui.EmployeeShowViewModel
...
//        }
        when (employee.role) {
            Role.Staff.ordinal -> {
                employee_role.text = Role.Staff.name
            }
            Role.Worker.ordinal -> {
                employee_role.text = Role.Worker.name
            }
            else -> {
                employee_role.text = Role.Manager.name
            }
        }
